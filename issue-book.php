...
<body>
  ...
  <!-- End Sidebar-->
  <script src="./scripts/issue.js" type="text/javascript" language="javascript"></script>
            ...
            <div class="card-body">
              ...
              <form class="row g-3">
                ...
                <div class="text-center">
                  ...
                  <div id="msg"></div><br>
                  <button type="button" class="btn btn-primary" id="btnSubmitIssue" name="btnSubmitIssue">Issue Book</button>
                </div>
              </form><!-- Vertical Form -->
            </div>
          </div>
