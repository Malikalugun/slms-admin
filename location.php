              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $res['section']?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Column Name</div>
                    <div class="col-lg-9 col-md-8"><?php echo $res['column_name']?></div>
                  </div>
